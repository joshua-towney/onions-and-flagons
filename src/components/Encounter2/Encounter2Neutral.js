...
export default function Encounter2Neutral({ encounter2 }) {
    return (
        <div>
            ...
            <h2>Thanos: "Perfectly unbalanced. Killing you will bring me great pleasure"</h2>
            <button onClick={encounter2}>
                Rethink choices
            </button>
        </div>
    )
