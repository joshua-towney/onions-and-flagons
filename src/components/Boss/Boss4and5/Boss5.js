...
export default function Boss5({ victory }) {
    return (
        <div>
            ...
            <h2>Dwayne rocks back and forth, his mouth is agape.</h2>
            <h2>( Let's finish this. Time to feed piggy )</h2>
            <button onClick={victory}>Magazine</button>
